...
cold-start-timeout
### **Summary**
Server cold start takes too long, client times out
### **Severity**
high
### **Situation**
First request after deployment fails or is very slow
### **Why**
...
### **Detection Pattern**
healthcheck|HEALTHCHECK|ready|startup

## Session Affinity Missing

### **Id**
session-affinity-missing
### **Summary**
Requests fail because they hit different server instances
### **Severity**
high
### **Situation**
Streamable HTTP streaming fails mid-stream
### **Why**
...
### **Detection Pattern**
session|affinity|sticky|upstream
...
critical
### **Situation**
Container image contains hardcoded credentials
### **Why**
...
### **Detection Pattern**
API_KEY|SECRET|PASSWORD|COPY.*\.env
...
no-graceful-shutdown
### **Summary**
Server drops connections on restart
### **Severity**
medium
### **Situation**
Deployment causes request failures
### **Why**
