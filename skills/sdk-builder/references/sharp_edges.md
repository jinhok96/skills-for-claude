...
breaking-change-minor
### **Summary**
Breaking change in minor version breaks user builds
### **Severity**
critical
### **Situation**
Changing API without major version bump
### **Why**
...
retry-without-backoff
### **Summary**
Retry without backoff creates thundering herd
### **Severity**
high
### **Situation**
...
missing-timeout
### **Summary**
No timeout causes request to hang indefinitely
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
timeout|httpx|aiohttp|requests\.
...
critical
### **Situation**
Credentials in logs, errors, or debug output
### **Why**
...
blocking-async-event-loop
### **Summary**
Sync SDK blocks async applications
### **Severity**
high
### **Situation**
SDK uses sync HTTP in async application
### **Why**
...
### **Detection Pattern**
requests\.|urllib|sync.*async|asyncio.*run
...
no-connection-pooling
### **Summary**
New connection per request slows everything
### **Severity**
medium
### **Situation**
Creating HTTP client for each request
### **Why**
...
### **Detection Pattern**
async with httpx|with requests\.Session
...
generic-error-messages
### **Summary**
Unhelpful errors frustrate developers
### **Severity**
medium
### **Situation**
