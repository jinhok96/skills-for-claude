# Vue Nuxt - Sharp Edges

## Reactivity Loss Destructure
...
### **Detection Pattern**
const\s*\{[^}]+\}\s*=\s*(reactive|defineProps|use\w+Store)\(
...
### **Detection Pattern**
if\s*\(\s*\w+\s*[=!]==?\s*[0-9"'true|false|null]
...
async-setup-blocking
### **Summary**
Async operations in setup() block component mounting
### **Severity**
high
### **Situation**
...
### **Symptoms**
  ...
  - Slow initial load
### **Detection Pattern**
<script setup[^>]*>[^]*await\s+(?!useFetch|useAsyncData)

## Stale Closure In Watch

### **Id**
stale-closure-in-watch
### **Summary**
Closures in watch/computed capture stale values
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
computed\s*\(\s*\(\s*\)\s*=>\s*[^)]*\b(?!\.value)\b\w+\s*[+\-*/]
...
nuxt-hydration-mismatch
### **Summary**
Server HTML doesn't match client-rendered DOM
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
(new Date\(\)|Math\.random\(\)|window\.|document\.)

## Pinia Store Outside Setup

### **Id**
pinia-store-outside-setup
### **Summary**
Using Pinia store outside of setup context
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
const\s+\w+\s*=\s*use\w+Store\(\)\s*\n\s*\n\s*export

## Vmodel Modifier Ignored

### **Id**
vmodel-modifier-ignored
### **Summary**
v-model modifiers not handled in custom component
### **Severity**
medium
### **Situation**
...
## Watch Immediate Missing

### **Id**
watch-immediate-missing
### **Summary**
Watch callback doesn't run on initial value
### **Severity**
medium
### **Situation**
...
template-ref-timing
### **Summary**
Template ref is null during setup
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
const\s+\w+\s*=\s*ref\s*<\s*HTML\w+Element