...
medium
### **Situation**
Script fails when you try to share it
### **Why**
...
### **Detection Pattern**
doesn't work|your machine|path|install|depend
...
medium
### **Situation**
Too many config options making the tool unusable
### **Why**
...
### **Detection Pattern**
config|option|flag|setting|customize
...
low
### **Situation**
Tool you built is now broken and you don't want to fix it
### **Why**
...
### **Detection Pattern**
abandon|old|broken|maintain|forgot
...
high
### **Situation**
Your personal tool exposes sensitive data or access
### **Why**
...
### **Detection Pattern**
security|credential|secret|key|token|password|exposed