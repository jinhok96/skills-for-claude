...
Extract structured data from PDFs using Claude's vision
  #### **When**
User needs to extract data from PDF documents
  #### **Implementation**
...
Extract structured invoice data with Zod schema enforcement
  #### **When**
User needs to process invoices or receipts
  #### **Implementation**
    import Anthropic from "@anthropic-ai/sdk";
    import { z } from "zod";
...
Extract tables as structured data from PDFs/images
  #### **When**
User needs to extract tabular data from documents
  #### **Implementation**
...
Build Q&A over documents with vision-enhanced RAG
  #### **When**
User needs to query large document collections
  #### **Implementation**
    import OpenAI from "openai";
...
Parse complex documents with LlamaParse API
  #### **When**
Need specialized document parsing beyond basic vision
  #### **Implementation**
...
Process documents with Unstructured API
  #### **When**
Need enterprise-grade document processing
  #### **Implementation**
...
Processing large PDFs without chunking
  #### **Why Bad**
Exceeds token limits, causes timeouts, high costs
  #### **Example Bad**
...
No schema validation on extracted data
  #### **Why Bad**
LLMs can hallucinate fields, produce invalid JSON
  #### **Example Bad**
...
Ignoring low image quality
  #### **Why Bad**
Poor scans produce garbage extraction
  #### **Example Bad**
...
Not handling multi-column layouts
  #### **Why Bad**
Text gets jumbled between columns
  #### **Example Bad**
