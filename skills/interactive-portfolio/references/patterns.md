...
Structure that works for portfolios
  #### **When To Use**
When planning portfolio structure
  #### **Implementation**
    ## Portfolio Architecture
...
How to present work effectively
  #### **When To Use**
When building project sections
  #### **Implementation**
    ## Project Showcase
...
What works for dev portfolios
  #### **When To Use**
When building developer portfolio
  #### **Implementation**
    ## Developer Portfolio
...
Beautiful but no real work
  #### **Why Bad**
    Fancy animations, weak projects.
    Style over substance.
    Hiring managers see through it.
    No proof of skills.
    
  #### **What To Do Instead**
    Projects first, style second.
