...
hallucinated-api
### **Summary**
LLM generates code using APIs that don't exist
### **Severity**
critical
### **Situation**
Code looks correct but errors on non-existent methods
### **Why**
...
### **Detection Pattern**
GetComponent|Instantiate|AddForce|Input\.
...
silent-logic-bugs
### **Summary**
Generated code compiles but has subtle logic errors
### **Severity**
critical
### **Situation**
Game works until edge case reveals AI introduced bug
### **Why**
...
context-window-exceeded
### **Summary**
Project grows beyond what LLM can hold in context
### **Severity**
high
### **Situation**
AI gives inconsistent responses, forgets earlier code
### **Why**
...
dependency-version-mismatch
### **Summary**
Generated code uses wrong package/library versions
### **Severity**
high
### **Situation**
Package.json/requirements have version conflicts
### **Why**
...
architecture-drift
### **Summary**
Each AI session creates inconsistent architecture
### **Severity**
high
### **Situation**
Codebase becomes Frankenstein of different patterns
### **Why**
...
### **Detection Pattern**
Manager|Controller|Service|Singleton
...
test-coverage-illusion
### **Summary**
AI-generated tests pass but don't actually test behavior
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
Test|test_|_test|Should|Assert
...
medium
### **Situation**
Multiplayer game gets exploited via AI-generated netcode
### **Why**
...
### **Detection Pattern**
RPC|ClientRpc|ServerRpc|[Command]|[ClientCallback]