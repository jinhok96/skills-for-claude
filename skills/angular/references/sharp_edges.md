...
change-detection-default
### **Summary**
Default change detection causes performance problems at scale
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
@Component\s*\(\s*\{(?!.*changeDetection)

## Memory Leak Subscriptions

### **Id**
memory-leak-subscriptions
### **Summary**
Subscriptions not unsubscribed cause memory leaks
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
\.subscribe\s*\([^)]+\)(?!.*takeUntil|.*takeUntilDestroyed)
...
template-method-calls
### **Summary**
Methods called in templates run on every change detection
### **Severity**
high
### **Situation**
...
rxjs-nested-subscribes
### **Summary**
Nested subscribes create callback hell and race conditions
### **Severity**
medium
### **Situation**
...
circular-dependency
### **Summary**
Services that inject each other cause runtime errors
### **Severity**
medium
### **Situation**
...
## Async Validator Spam

### **Id**
async-validator-spam
### **Summary**
Async validators fire on every keystroke without debounce
### **Severity**
medium
### **Situation**
...
### **Symptoms**
  ...
  - Slow form response
### **Detection Pattern**
asyncValidators.*http\.get

## Zone Js External Async

### **Id**
zone-js-external-async
### **Summary**
Async operations outside Angular zone don't trigger updates
### **Severity**
medium
### **Situation**
...
## Router Resolver Blocking

### **Id**
router-resolver-blocking
### **Summary**
Route resolvers block navigation and frustrate users
### **Severity**
medium
### **Situation**
