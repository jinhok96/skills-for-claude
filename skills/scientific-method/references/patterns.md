...
Transform research questions into testable hypotheses
  #### **When**
Starting any research or experimental work
  #### **Pattern**
  ...
  #### **Why**
Pre-registered hypotheses prevent HARKing and p-hacking
### **Experimental Design**
  #### **Name**
Designing Controlled Experiments
  #### **Description**
Structure experiments with proper controls and randomization
  #### **When**
Planning any comparative study or A/B test
  #### **Pattern**
    import random
  ...
  #### **Why**
Proper controls distinguish real effects from noise and bias
### **Computational Reproducibility**
  #### **Name**
Ensuring Computational Reproducibility
  #### **Description**
Make experiments reproducible by others
  #### **When**
Running any computational experiment or analysis
  #### **Pattern**
    import hashlib
    import json
    import subprocess
  ...
  #### **Why**
Only 11% of studies can be reproduced - proper infrastructure is essential
### **Power Analysis**
  #### **Name**
Statistical Power Analysis
  #### **Description**
Determine required sample size before running experiments
  #### **When**
Planning any quantitative study
  #### **Pattern**
  ...
  #### **Why**
Underpowered studies waste resources and produce unreliable results
### **Avoiding P Hacking**
  #### **Name**
...
Analyzing experimental data
  ...
  #### **Why**
P-hacking inflates false positive rates from 5% to over 60%
### **Effect Size Reporting**
  #### **Name**
Reporting Effect Sizes and Confidence Intervals
  #### **Description**
Go beyond p-values to practical significance
  #### **When**
Reporting any statistical results
  #### **Pattern**
    from scipy import stats
    import numpy as np
    from dataclasses import dataclass
  ...
  #### **Why**
Effect sizes communicate practical significance beyond statistical significance
...
P-Hacking (Data Dredging)
  #### **Description**
Searching for significant results through multiple analyses
  #### **Problem**
  ...
  #### **Impact**
False positive rate inflates from 5% to 60%+
### **Harking**
  #### **Name**
HARKing (Hypothesizing After Results Known)
  #### **Description**
Formulating hypothesis after seeing data
  #### **Problem**
    # Look at data first
  ...
  #### **Impact**
Destroys scientific validity, unreproducible findings
### **Underpowered Studies**
  #### **Name**
Underpowered Studies
  #### **Description**
Running experiments without enough samples
  #### **Problem**
  ...
  #### **Impact**
Wasted resources, false negatives, unreliable science
...
Inferring causation from observational data
  ...
  #### **Impact**
Invalid conclusions, wasted interventions