...
## Unreported Random Seeds = Irreproducible Results

### **Id**
reproducibility-crisis-seeds
### **Severity**
critical
### **Summary**
Most ML/stats papers can't be reproduced because random seeds weren't documented
### **Symptoms**
...
### **Detection Pattern**
random\.|np\.random|torch\.manual_seed(?!.*cuda)
### **References**
  - https://pytorch.org/docs/stable/notes/randomness.html
  - Bouthillier et al. 'Accounting for Variance in Machine Learning Benchmarks'

## Multiple Comparisons Inflate False Positives to 60%+
...
critical
### **Summary**
Running 20 tests at alpha=0.05 gives 64% chance of at least one false positive
### **Symptoms**
...
## HARKing Destroys Scientific Validity
...
critical
### **Summary**
Hypothesizing After Results are Known turns exploration into false confirmation
### **Symptoms**
...
### **Detection Pattern**
hypothesis.*after|predict.*after.*analy
### **References**
  - Kerr, N. L. (1998). HARKing: Hypothesizing After the Results are Known

## Survivorship Bias Skews All Conclusions

### **Id**
survivorship-bias-samples
### **Severity**
critical
### **Summary**
Analyzing only 'successful' cases leads to backwards conclusions
### **Symptoms**
...
### **Detection Pattern**
success|survivors|current_users
### **References**
...
high
### **Summary**
With n=20, you need Cohen's d > 0.9 to detect at 80% power
### **Symptoms**
...
### **Detection Pattern**
p.*<.*0\.05.*significant|confidence.*p-value
### **References**
...
high
### **Summary**
Information from test set leaking into training destroys validity
### **Symptoms**
...
### **Detection Pattern**
fit_transform.*train_test_split|StandardScaler.*split

## Confirmation Bias Makes You See What You Expect
...
high
### **Summary**
We scrutinize unexpected results more than expected ones
### **Symptoms**
...
### **Detection Pattern**
corr.*implies|causes.*correlation

## Overfitting Your Hypothesis to Data
...
medium
### **Summary**
Adding parameters until your hypothesis 'explains' the data
### **Symptoms**
...
### **Detection Pattern**
refine|adjust.*hypothesis|subgroup.*significant

## One Study Is Not Proof

### **Id**
single-study-overconfidence
### **Severity**
medium
### **Summary**
A single significant result has high false positive probability
### **Symptoms**
...
medium
### **Summary**
Seemingly reasonable analysis decisions multiply to create many implicit tests
### **Symptoms**
