# Agent Based Modeling - Sharp Edges

## Update Order Creates Artificial Dynamics
...
critical
### **Summary**
Sequential updates give unfair advantage to early agents
### **Symptoms**
...
## Grid Discretization Creates Unrealistic Patterns
...
high
### **Summary**
Square grid creates directional bias in movement
### **Symptoms**
...
## Emergent Behavior Depends on Agent Count
...
high
### **Summary**
Patterns change qualitatively with population size
### **Symptoms**
...
## Small Parameter Changes Cause Qualitative Shifts
...
medium
### **Summary**
Model is on edge of phase transition, unstable
### **Symptoms**
...
## Simulation Becomes Intractably Slow
...
medium
### **Summary**
O(N^2) interactions or too-small timesteps
### **Symptoms**
...
## No Empirical Validation of Emergent Behavior
...
medium
### **Summary**
Model produces patterns but no proof they match reality
### **Symptoms**
