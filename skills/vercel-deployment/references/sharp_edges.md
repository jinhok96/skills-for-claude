...
critical
### **Situation**
Using NEXT_PUBLIC_ prefix for sensitive API keys
### **Why**
...
### **Detection Pattern**
NEXT_PUBLIC_.*(?:SECRET|PRIVATE|SERVICE_ROLE|DATABASE_URL)
### **Version Range**
>=1.0.0
...
high
### **Situation**
Not configuring separate environment variables for preview
### **Why**
...
high
### **Situation**
API route or server component has slow initial load
### **Why**
...
high
### **Situation**
Using Node.js APIs in edge runtime functions
### **Why**
...
### **Symptoms**
  ...
  - Middleware crashes
### **Detection Pattern**
runtime.*edge[\s\S]*import.*(?:fs|path|crypto)
### **Version Range**
>=1.0.0
...
medium
### **Situation**
Environment variable works in build but undefined at runtime
### **Why**
...
medium
### **Situation**
Frontend on different domain can't call API routes
### **Why**
...
medium
### **Situation**
Updated data not appearing after new deployment
### **Why**
