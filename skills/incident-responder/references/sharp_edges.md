...
## Cascade Investigation - Chasing Symptoms
...
### **Detection Pattern**
investigating|looking at|checking|seems slow

## Alert Storm Paralysis - Too Many Alerts

### **Id**
alert-storm-paralysis
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
many alerts|alert storm|which alert|so many

## Keyboard Cowboy - Untested Fixes in Production
...
### **Detection Pattern**
just fix|quick change|try this|hotfix

## Post-Mortem Theater - Going Through the Motions
...
### **Solution**
  ...
  4. Quality over quantity:
     ...
     - "Add monitoring" → "Add alert for X threshold"
...
### **Detection Pattern**
post-mortem|retro|action items|follow up

## Severity Inflation - Everything Is SEV1
...
### **Detection Pattern**
SEV1|critical|emergency|all hands

## Missing Timeline - "What Actually Happened?"
...
### **Detection Pattern**
timeline|sequence|when did|first notice

## Communication Blackout - Where's the Update?
...
### **Detection Pattern**
update|status|what's happening|any news

## Rollback Fear - "But We'll Lose the Feature"
...
### **Detection Pattern**
fix first|save the deploy|can we patch