# Clinical Trial Analysis - Sharp Edges

## Assuming PFS Improvement Means OS Improvement
...
critical
### **Summary**
PFS gains don't always translate to OS benefit - can even show harm
### **Symptoms**
...
## Post-Hoc Subgroup Fishing After Overall Trial Failure
...
critical
### **Summary**
Finding 'significant' subgroups invalidates statistical inference
### **Symptoms**
...
## Using Cox Model When Proportional Hazards Violated
...
high
### **Summary**
Hazard ratio meaningless when hazards cross
### **Symptoms**
...
## Immortal Time Bias in Observational Analyses
...
critical
### **Summary**
Misclassifying time before treatment as treated time
### **Symptoms**
...
## Informative Censoring Biasing Survival Estimates
...
high
### **Summary**
Censoring correlated with outcome violates assumptions
### **Symptoms**
