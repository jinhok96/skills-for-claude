...
## False Debt Diagnosis - Old ≠ Bad

### **Id**
false-debt-diagnosis
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
old code|legacy|rewrite|outdated

## Infinite Debt Backlog - The Mountain of Guilt
...
### **Detection Pattern**
debt backlog|technical debt list|cleanup items

## Scope Creep Refactoring - While I'm Here
...
### **Detection Pattern**
while I'm here|also refactored|cleaned up|improved

## Debt Without Interest - Phantom Debt
...
### **Detection Pattern**
we should|someday|nobody touches|old system

## All Debt Is Equal - Undifferentiated Backlog
...
### **Detection Pattern**
tech debt list|all the debt|same priority

## Debt Denial Culture - "We're Fine"
...
### **Detection Pattern**
we're fine|no debt|deal with it later

## Premature Debt Payment - Paying Before Interest

### **Id**
premature-debt-payment
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
clean up|refactor.*that works|make it nicer

## Rewrite as Debt Payment - The Nuclear Option
...
### **Detection Pattern**
rewrite|from scratch|start fresh|version 2