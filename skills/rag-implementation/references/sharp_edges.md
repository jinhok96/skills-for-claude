...
chunking-destroys-context
### **Summary**
Poor chunking ruins retrieval quality
### **Severity**
critical
### **Situation**
Retrieved chunks don't have enough context to be useful
### **Why**
...
rag-latency-spike
### **Summary**
RAG adds significant latency to responses
### **Severity**
high
### **Situation**
User-facing latency unacceptable
### **Why**
...
stale-embeddings
### **Summary**
Documents updated but embeddings not refreshed
### **Severity**
medium
### **Situation**
