...
bias-amplification
### **Summary**
Synthetic data amplifies existing biases
### **Severity**
critical
### **Situation**
Generating data from biased source
### **Why**
...
data-leakage-memorization
### **Summary**
LLM memorizes and reproduces real data
### **Severity**
critical
### **Situation**
Using LLM for synthetic generation
### **Why**
...
distribution-drift
### **Summary**
Synthetic data drifts from real distribution
### **Severity**
high
### **Situation**
...
## Overfitting To Synthetic

### **Id**
overfitting-to-synthetic
### **Summary**
Model overfits to synthetic data artifacts
### **Severity**
high
### **Situation**
...
privacy-not-guaranteed
### **Summary**
Synthetic data doesn't guarantee privacy
### **Severity**
high
### **Situation**
...
mode-collapse
### **Summary**
Generator produces repetitive outputs
### **Severity**
medium
### **Situation**
Using GANs or low temperature
### **Why**
...
llm-hallucination-in-data
### **Summary**
LLM generates factually incorrect data
### **Severity**
medium
### **Situation**
...
cost-explosion
### **Summary**
LLM generation costs spiral out of control
### **Severity**
medium
### **Situation**
Generating large datasets with LLM
### **Why**
