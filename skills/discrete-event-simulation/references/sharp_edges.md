# Discrete Event Simulation - Sharp Edges

## Floating Point Time Causes Event Ordering Errors
...
critical
### **Summary**
Accumulated floating point errors corrupt event sequence
### **Symptoms**
...
## Warm-up Period Not Removed, Biased Results
...
high
### **Summary**
Initial transient contaminates steady-state statistics
### **Symptoms**
...
high
### **Summary**
No estimate of output variability
### **Symptoms**
...
## Arbitrary Tiebreaking for Same-Time Events
...
medium
### **Summary**
Event ordering at same time affects results
### **Symptoms**
...
## Deadlock from Circular Resource Requests
...
medium
### **Summary**
Entities wait forever for resources held by each other
### **Symptoms**
  - Simulation hangs
...
## Infinite Queue Assumption Hides Blocking
...
medium
### **Summary**
Real systems have finite buffers, model assumes infinite
### **Symptoms**
