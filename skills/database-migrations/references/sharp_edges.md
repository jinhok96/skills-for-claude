# Database Migrations - Sharp Edges

## Not Null Large Table

### **Id**
not-null-large-table
### **Summary**
Adding NOT NULL to large table locks everything
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
ALTER.*ADD.*NOT NULL(?!.*DEFAULT)

## Column Rename Breaks Code
...
long-running-transaction
### **Summary**
Long migration holding locks forever
### **Severity**
high
### **Situation**
...
drop-column-with-index
### **Summary**
Dropping column without dropping dependent indexes
### **Severity**
medium
### **Situation**
...
enum-modification
### **Summary**
Modifying enums is surprisingly hard
### **Severity**
medium
### **Situation**
