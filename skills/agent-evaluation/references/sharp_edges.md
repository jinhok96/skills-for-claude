...
high
### **Situation**
High benchmark scores don't predict real-world performance
### **Why**
...
### **Detection Pattern**
benchmark|score|accuracy|performance
...
high
### **Situation**
Test suite is unreliable, CI is broken or ignored
### **Why**
...
medium
### **Situation**
Agent scores well on metric but quality is poor
### **Why**
...
critical
### **Situation**
Agent has seen test examples, artificially inflating scores
### **Why**
...
### **Detection Pattern**
train|test|eval|dataset|fine.?tune