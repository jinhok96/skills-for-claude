...
flash-loan-governance-attack
### **Summary**
Flash loans can borrow voting power for single block
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
balanceOf.*getVotes|voting.*balanceOf
...
proposal-griefing
### **Summary**
Attackers spam proposals to cause governance fatigue
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
proposalThreshold.*=.*0|propose.*public(?!.*threshold)
...
quorum-sniping
### **Summary**
Proposals pass with minimal votes during low activity
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
quorum.*\d{1,3}[^0-9]|quorumNumerator.*<.*4
...
timelock-bypass
### **Summary**
Emergency functions bypass governance timelock
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
emergency.*call|guardian.*arbitrary
...
delegation-confusion
### **Summary**
Self-delegation required but not documented
### **Severity**
low
### **Situation**
...
vote-buying
### **Summary**
Bribes and vote markets undermine governance
### **Severity**
high
### **Situation**
...
proposal-front-running
### **Summary**
Attackers front-run profitable proposals
### **Severity**
medium
### **Situation**
