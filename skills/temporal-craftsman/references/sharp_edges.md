...
workflow-non-determinism
### **Summary**
Non-deterministic code in workflow causes replay failure
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
import uuid|uuid\\.uuid4\\(\\)|datetime\\.now\\(\\)|random\\.
### **Version Range**
>=1.0.0

## Workflow History Overflow

### **Id**
workflow-history-overflow
### **Summary**
Long-running workflow exceeds history limit
### **Severity**
critical
### **Situation**
...
activity-timeout-too-short
### **Summary**
Default activity timeout kills ML/LLM operations
### **Severity**
high
### **Situation**
...
## Missing Activity Heartbeat

### **Id**
missing-activity-heartbeat
### **Summary**
Long activity killed due to missing heartbeat
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
activity\\.defn.*for.*in.*:(?!.*heartbeat)
### **Version Range**
>=1.0.0

## Workflow Versioning Skipped

### **Id**
workflow-versioning-skipped
### **Summary**
Code change breaks running workflows
### **Severity**
high
### **Situation**
...
### **Detection Pattern**
workflow\\.defn(?!.*patched|.*deprecated)
### **Version Range**
>=1.0.0

## Child Workflow Orphan

### **Id**
child-workflow-orphan
### **Summary**
Child workflows continue after parent cancelled
### **Severity**
medium
### **Situation**
...
## Task Queue Single Worker

### **Id**
task-queue-single-worker
### **Summary**
All workflows on one worker creates bottleneck
### **Severity**
medium
### **Situation**
...
signal-handler-blocking
### **Summary**
Signal handler does work instead of just updating state
### **Severity**
medium
### **Situation**
