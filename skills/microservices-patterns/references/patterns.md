...
Define services around business domains
  #### **When**
Breaking down a monolith or designing new services
  #### **Pattern**
  ...
  #### **Why**
Bounded contexts minimize coupling and allow independent evolution
### **Api Gateway**
  #### **Name**
API Gateway Pattern
  #### **Description**
...
Clients need to interact with multiple services
  ...
  #### **Why**
Gateway simplifies client code and centralizes cross-cutting concerns
### **Sync Communication**
  #### **Name**
...
Need immediate response from another service
  ...
  #### **Why**
Sync communication is simple but requires resilience patterns
### **Async Communication**
  #### **Name**
...
Publish-subscribe messaging between services
  #### **When**
Services can react eventually, need loose coupling
  #### **Pattern**
  ...
  #### **Why**
Async communication provides loose coupling and better resilience
### **Circuit Breaker**
  #### **Name**
...
Isolate failures to prevent resource exhaustion
  #### **When**
Want to prevent slow services from consuming all resources
  #### **Pattern**
  ...
  #### **Why**
Bulkheads prevent one slow dependency from blocking all requests
### **Saga Pattern**
  #### **Name**
...
Manage transactions across multiple services
  #### **When**
Operation spans multiple services that need consistency
  #### **Pattern**
  ...
  #### **Why**
Sagas maintain consistency across services without distributed transactions
...
Each service owns its data store
  #### **When**
Designing microservices data architecture
  #### **Pattern**
  ...
  #### **Why**
Separate databases enable independent scaling and evolution
### **Cqrs Pattern**
  #### **Name**
...
Read and write patterns are very different
  ...
  #### **Why**
CQRS allows optimizing reads and writes independently
### **Distributed Tracing**
  #### **Name**
Distributed Tracing
  #### **Description**
Track requests across service boundaries
  #### **When**
Need to debug issues in distributed system
  #### **Pattern**
...
Distributed Monolith
  #### **Description**
Microservices tightly coupled like a monolith
  #### **Problem**
  ...
  #### **Impact**
Defeats the purpose of microservices, fragile system
### **Chatty Services**
  #### **Name**
...
Too many small calls between services
  ...
  #### **Impact**
High latency, cascade failures, network saturation
### **Shared Database**
  #### **Name**
...
Multiple services sharing one database
  ...
  #### **Impact**
Tight coupling, no independent evolution, scaling issues
### **No Timeout**
  #### **Name**
Missing Timeouts on Service Calls
  #### **Description**
Calls hang forever when service is slow
  #### **Problem**
  ...
  #### **Impact**
Thread exhaustion, cascade failures, poor UX