# Microservices Patterns - Sharp Edges
...
distributed-monolith
### **Summary**
Building a distributed monolith is worse than a real monolith
### **Severity**
critical
### **Situation**
...
no-timeouts
### **Summary**
Missing timeouts cause cascade failures
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
axios\\.get\\((?![^)]*timeout)|fetch\\((?![^)]*signal)
...
no-circuit-breaker
### **Summary**
Missing circuit breaker causes cascade failures
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
axios|fetch|grpc(?![\\s\\S]{0,500}circuit|breaker|opossum)
...
shared-database
### **Summary**
Shared database between services defeats microservices benefits
### **Severity**
critical
### **Situation**
...
### **Detection Pattern**
shared.?database|multiple.*services.*same.*table
...
### **Detection Pattern**
await.*Service.*await.*Service(?![\\s\\S]{0,200}parallel|Promise\\.all)
...
### **Detection Pattern**
axios\\.post(?![\\s\\S]{0,200}correlation|traceId|requestId)
...
### **Detection Pattern**
await.*Service.*for.*of|Promise\\.all\\([\\s\\S]{0,50}\\.map
...
no-idempotency
### **Summary**
Non-idempotent operations cause duplicate processing
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
eventBus\\.subscribe(?![\\s\\S]{0,500}idempotency|dedupe)
...
version-coupling
### **Summary**
All services must deploy together due to API coupling
### **Severity**
medium
### **Situation**
...
### **Detection Pattern**
break.*change|deploy.*together|coordinate.*deploy