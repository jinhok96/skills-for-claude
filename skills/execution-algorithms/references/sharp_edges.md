# Execution Algorithms - Sharp Edges

## Your Slippage Estimate Is 3-5x Too Low
...
## HFTs Are Trading Against Your Patterns
...
## Dark Pools Are Not Actually Dark
...
## Partial Fills Are Adverse Selection
...
## Chasing Rebates Costs More Than You Earn

### **Id**
exchange-rebate-trap
### **Severity**
HIGH
### **Description**
Posting for rebates often results in worse overall execution
### **Symptoms**
  - I always post for the rebate
  - Good queue position but bad fills
  - High rebate income but worse total returns
### **Detection Pattern**
rebate|maker|taker|fee
### **Solution**
  The Rebate Trap:
...
## Your Volume Curve Is From Last Month
...
## Your Limit Order Is Stale (And Getting Picked Off)
...
## You Got More Fills Than Expected
