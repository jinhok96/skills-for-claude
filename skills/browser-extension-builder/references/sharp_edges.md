...
high
### **Situation**
Background scripts stop working in Manifest V3
### **Why**
...
### **Detection Pattern**
service worker|terminate|MV3|background.*stop
...
content-script-isolation
### **Summary**
Content script can't access page JavaScript
### **Severity**
medium
### **Situation**
Can't read page's JavaScript variables
### **Why**
...
### **Detection Pattern**
page variable|window\.|isolated|can't access
...
high
### **Situation**
Extension rejected, unclear why
### **Why**
  Policy violations.
...
### **Symptoms**
  ...
  - Appeals denied
### **Detection Pattern**
rejected|store|policy|violation|removed
...
### **Detection Pattern**
Firefox|cross-browser|browser\.|polyfill