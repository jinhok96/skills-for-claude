...
async-blocking-call
### **Summary**
Blocking call in async function freezes entire event loop
### **Severity**
critical
### **Situation**
Using sync library in async code
### **Why**
...
### **Detection Pattern**
requests\.|time\.sleep|psycopg2|open\(
...
pydantic-v1-vs-v2
### **Summary**
Pydantic V1 patterns fail silently in V2
### **Severity**
high
### **Situation**
Mixing Pydantic V1 and V2 patterns
### **Why**
...
type-narrowing-failure
### **Summary**
mypy doesn't understand your type narrowing
### **Severity**
medium
### **Situation**
Complex conditionals that narrow types
### **Why**
...
### **Detection Pattern**
type:\s*ignore|cast\(|assert.*is not None
...
async-generator-not-closed
### **Summary**
Async generator left open leaks resources
### **Severity**
medium
### **Situation**
Using async for without proper cleanup
### **Why**
...
### **Symptoms**
  ...
  - Too many open files
### **Detection Pattern**
async for.*break|async def.*yield
...
dependency-hell
### **Summary**
Dependencies conflict, install fails or breaks
### **Severity**
high
### **Situation**
