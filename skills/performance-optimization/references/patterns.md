...
Optimizing before measuring
  #### **Wrong**
Let me add Redis caching to everything
  #### **Right**
Let me profile first to find the actual bottlenecks
### **Over Caching**
  #### **Description**
...
Cache all API responses for 1 hour
  #### **Right**
Cache with appropriate TTL and clear invalidation triggers
### **Blocking Main Thread**
  #### **Description**
Heavy computation on main thread
  #### **Wrong**
Process 10,000 items in a loop on render
  #### **Right**
Use Web Workers, virtualization, or pagination
### **No Loading States**
  #### **Description**
Not providing visual feedback during loads
  #### **Wrong**
Show nothing while fetching data
  #### **Right**
Use skeletons, progress indicators, optimistic updates