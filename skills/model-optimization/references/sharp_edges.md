# Model Optimization - Sharp Edges

## Quantization Fails on Production Data
...
critical
### **Summary**
Calibration data doesn't represent real inference data
### **Symptoms**
...
## QAT Model Forgets After Training
...
high
### **Summary**
Quantization-aware training causes catastrophic forgetting
### **Symptoms**
...
## ONNX Model Has Fixed Batch Size

### **Id**
onnx-dynamic-axes-missing
### **Severity**
high
### **Summary**
Forgot to specify dynamic axes during export
### **Symptoms**
...
## TensorRT Engine Doesn't Use FP16

### **Id**
tensorrt-precision-mismatch
### **Severity**
medium
### **Summary**
Enabled FP16 but engine still runs in FP32
### **Symptoms**
...
## Pruned Model Same Speed as Original
...
medium
### **Summary**
Unstructured pruning doesn't give actual speedup
### **Symptoms**
