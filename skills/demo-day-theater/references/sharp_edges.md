...
live-demo-disaster
### **Summary**
Demo fails catastrophically in front of stakeholders
### **Severity**
high
### **Situation**
Everything breaks during the presentation
### **Why**
  No backup prepared.
...
### **Symptoms**
  ...
  - Demo derailed
### **Detection Pattern**
it's not working|give me a second|that's weird
...
wrong-audience
### **Summary**
Demo pitched at wrong level for audience
### **Severity**
medium
### **Situation**
Executives glazed over, or engineers bored
### **Why**
...
### **Symptoms**
  ...
  - Can you go deeper
### **Detection Pattern**
don't understand|too technical|more detail|so what
...
invisible-progress
### **Summary**
Good work doesn't get recognized
### **Severity**
medium
### **Situation**
Doing great work but nobody knows
### **Why**
  Work isn't demoable.
...
### **Symptoms**
  ...
  - Resource cuts
### **Detection Pattern**
what are you working on|no progress|nothing to show
...
demo-scope-creep
### **Summary**
Demo grows to show everything
### **Severity**
medium
### **Situation**
5-minute demo becomes 30-minute tour
### **Why**
...
### **Symptoms**
  ...
  - No time for Q&A
### **Detection Pattern**
one more thing|also|running out of time|quickly show