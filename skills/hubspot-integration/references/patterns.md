...
Secure authentication for public apps
  #### **When**
Building public app or multi-account integration
  #### **Template**
...
Authentication for single-account integrations
  #### **When**
Building internal integration for one HubSpot account
  #### **Template**
...
Create, read, update, delete CRM records
  #### **When**
Working with contacts, companies, deals, tickets
  #### **Template**
    import { Client } from "@hubspot/api-client";
...
Bulk create, update, or read records efficiently
  #### **When**
Processing multiple records (reduce rate limit usage)
  #### **Template**
    import { Client } from "@hubspot/api-client";
...
Create relationships between CRM records
  #### **When**
Linking contacts to companies, deals, etc.
  #### **Template**
...
Receive real-time notifications from HubSpot
  #### **When**
Need instant updates on CRM changes
  #### **Template**
...
Create and manage custom object types
  #### **When**
Standard objects don't fit your data model
  #### **Template**
    import { Client } from "@hubspot/api-client";
...
Only processes first page of results
  #### **Instead**
Always implement pagination with after cursor
