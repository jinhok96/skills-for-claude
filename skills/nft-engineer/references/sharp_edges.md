# Nft Engineer - Sharp Edges

## _safeMint Reentrancy Attack Vector
...
## Metadata 404s During Marketplace Indexing

### **Id**
metadata-404-indexing
### **Severity**
CRITICAL
### **Description**
...
## IPFS Gateway Dependency Creates Single Point of Failure

### **Id**
ipfs-gateway-single-point
### **Severity**
CRITICAL
### **Description**
...
### **Detection Pattern**
ipfs\.io|gateway\.pinata|cloudflare-ipfs|dweb\.link
### **Solution**
...
## Reveal Randomness Can Be Front-Run or Manipulated
...
### **Detection Pattern**
reveal|randomOffset|blockhash|block\.timestamp|block\.number
### **Solution**
...
### **Detection Pattern**
royaltyInfo|ERC2981|_setDefaultRoyalty
### **Solution**
...
## Large Batch Mints Hit Gas Limit and Fail

### **Id**
gas-limit-batch-failure
### **Severity**
HIGH
### **Description**
...
### **Detection Pattern**
function.*mint.*quantity.*\{(?!.*MAX|.*max)
### **Solution**
...
## Mutable Metadata Destroys Collector Trust

### **Id**
metadata-mutability-trust
### **Severity**
HIGH
### **Description**
...
## Withdraw Function Using transfer() Can Brick Funds

### **Id**
withdraw-transfer-failure
### **Severity**
HIGH
### **Description**
...
## Merkle Root Can Be Changed During Active Mint
...
## ERC-1155 Without Total Supply Tracking

### **Id**
erc1155-missing-supply
### **Severity**
MEDIUM
### **Description**
...
## Assuming Token IDs Start at 0

### **Id**
startTokenId-assumption
### **Severity**
MEDIUM
### **Description**
...
## tokenURI Returns Data for Non-Existent Tokens
...
### **Detection Pattern**
block\.timestamp.*price|block\.timestamp.*start|block\.timestamp.*end
### **Solution**
