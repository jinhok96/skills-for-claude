...
The original skills were defined in YAML format, which is excellent for machine readability but less ideal for direct usage as context in some AI IDEs like Antigravity. This project transforms those high-quality definitions into Markdown (`SKILL.md`) files that can be easily indexed and read by AI agents.
...
3.  **Formatting**: The repaired data is then reformatted into the Antigravity Skill Standard, creating:
